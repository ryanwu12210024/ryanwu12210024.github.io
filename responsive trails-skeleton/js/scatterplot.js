class Scatterplot {
    ...
    constructor(_config, _data) {
      this.config = {
        ...
        containerHeight: 400, //no containerWidth specified
    ...
    updateVis() {
      ...
      vis.config.containerWidth = document
          .getElementById(vis.config.parentElement.substring(1))
          .clientWidth;
      ...
      // Update SVG Size
      vis.svg.attr('width', vis.config.containerWidth)
